...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Okt 2023 pada 06.54
...
ALTER TABLE `tb_transaksi`
  ...
  ADD KEY `id_user` (`id_user`,`id_paket`),
  ADD KEY `id_outlet` (`id_outlet`),
...
ALTER TABLE `tb_transaksi`
  ...
  ADD CONSTRAINT `tb_transaksi_ibfk_3` FOREIGN KEY (`id_paket`) REFERENCES `tb_paket` (`id_paket`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `tb_user`
--
ALTER TABLE `tb_user`
  ADD CONSTRAINT `tb_user_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `tb_transaksi` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tb_user_ibfk_2` FOREIGN KEY (`id_outlet`) REFERENCES `tb_outlet` (`id_outlet`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
